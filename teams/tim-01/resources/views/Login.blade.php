...
<body class="bg-gradient-to-br from-[#F4F9F4] to-[#E3F6ED] dark:from-gray-900 dark:to-[#111827] min-h-screen flex flex-col justify-center items-center relative text-gray-800 dark:text-gray-200">

    <nav class="absolute top-0 left-0 w-full bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm shadow-sm dark:shadow-gray-800 z-50 px-6 md:px-8 py-4 flex justify-between items-center border-b border-transparent dark:border-gray-800">
        
        <a href="{{ url('/') }}" class="flex items-center gap-2 group hover:opacity-80 transition-opacity">
            <div class="w-10 h-10 rounded-xl bg-[#10B981] flex items-center justify-center text-white shadow-green-200 dark:shadow-none shadow-lg">
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="/" class="hidden md:flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-all text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-[#10C858] dark:hover:text-[#10C858]">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-[2rem] shadow-xl dark:shadow-none border border-transparent dark:border-gray-700 w-full max-w-[450px] p-10 z-10 mx-4 mt-20">
        ...
        @if ($errors->any())
        <div class="mb-4 bg-red-50 dark:bg-red-900/20 text-red-500 dark:text-red-400 text-xs px-4 py-3 rounded-xl border border-red-100 dark:border-red-800 flex gap-2 items-center animate-pulse">
        ...
        <form method="POST" action="/login">
            ...
            <div class="mb-2">
                ...
                <div class="relative">
                    ...
                    <button type="button" onclick="togglePassword()" class="absolute right-3 top-3.5 text-gray-400 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 transition-colors">
            ...
            <div class="flex justify-end mb-6">
                <a href="#" class="text-xs font-bold text-[#10B981] hover:text-green-600 dark:hover:text-green-400 hover:underline transition-colors">Lupa Kata Sandi?</a>
            </div>

            <button type="submit" class="w-full bg-[#10B981] hover:bg-green-600 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-green-200 dark:shadow-none transition-all transform active:scale-95 mb-6">
                Masuk
            </button>
        </form>
    </div>
