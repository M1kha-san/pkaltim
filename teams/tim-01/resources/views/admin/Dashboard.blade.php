            ...
            <div class="p-4 border-t border-gray-700/30">
                <div class="flex items-center gap-3 bg-gray-800/50 p-3 rounded-lg">
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-xs text-gray-400" style="max-width: 120px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                            {{ Auth::user()->email }}
                        </span>
                    </div>
                </div>
        ...
        <main class="flex-1 flex flex-col overflow-hidden bg-[#F9FAFB]">
            ...
            <div class="flex-1 overflow-y-auto p-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
                    <img src="https://illustrations.popsy.co/gray/creative-work.svg" alt="Empty State" class="h-48 mx-auto opacity-50 mb-4">
