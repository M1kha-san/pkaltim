...
@section('content')
    ...
    <header class="relative pt-20 pb-20 md:pt-32 md:pb-24 overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="https://lh3.googleusercontent.com/gps-cs-s/AHVAweqCfn2wgXu-qHU1M0N7a2P-QaHG6WCbttRp7K7qq4C5_Nr_hytuXgPT43ihTHsNljoaKSCXGAT1mJzHeBWbu4CVbGUjKpsRNTD20lH0B01WWW-CHV7k5mtOF3pXkOGrZMaICz1W=s1360-w1360-h1020-rw" alt="Pantai Melawai" class="w-full h-full object-cover">
        ...
        <div class="container mx-auto px-4 relative z-10 text-center">
            ...
            <div class="max-w-3xl relative z-10 mx-auto bg-white dark:bg-gray-800 p-2 rounded-full shadow-2xl flex flex-col md:flex-row items-center gap-2">
                <div class="flex-1 flex items-center px-6 w-full h-12">
                    <i class="fa-solid fa-search text-gray-400 mr-3"></i>
                    <!-- Added ID search-input -->
                    <input type="text" id="search-input" placeholder="Mau kemana hari ini?" class="w-full bg-transparent outline-none text-gray-700 dark:text-gray-200 placeholder-gray-400">
                </div>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center space-x-3 cursor-pointer group">
                                ...
                                <span class="group-hover:text-brand-500 text-gray-600 dark:text-gray-400">Semua Wisata</span>
                            </label>
            ...
            <div class="w-full lg:w-9/12">
                    ...
                    @forelse($destinations as $item)
                        <div class="destination-card bg-white dark:bg-gray-800 rounded-2xl p-3 shadow-sm hover:shadow-xl group border border-gray-100 dark:border-gray-700 flex flex-col h-full"
                            ...
                            <div class="relative rounded-xl overflow-hidden h-48 mb-4">
                                ...
                                @else
                                    <img src="https://images.unsplash.com/photo-1596401057633-565652f56878?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">
                                @endif
                                ...
                                <div class="absolute top-3 right-3 bg-white dark:bg-gray-900 text-xs font-bold px-2 py-1 rounded-md flex items-center shadow-md dark:text-white">
                            ...
                            <div class="px-2 pb-2 flex flex-col flex-grow">
                                <h3 class="font-bold text-lg text-gray-900 dark:text-white mb-1 line-clamp-1 group-hover:text-brand-500 destination-name">{{ $item->name }}</h3>
                ...
                <div class="mt-10 flex justify-center">
                    <button class="px-8 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full text-sm font-bold shadow hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-white">
                        Muat Lebih Banyak
                    </button>
                </div>
            </div>
